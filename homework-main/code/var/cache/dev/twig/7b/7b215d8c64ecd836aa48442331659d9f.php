    ...
    <div class=\"card-body\">
        ...
        echo "\" class=\"btn btn-sm btn-outline-secondary\">Edit</a>
            ...
            <small class=\"text-muted\">
                ";
        // line 19
        echo twig_escape_filter($this->env, (isset($context["readingTime"]) || array_key_exists("readingTime", $context) ? $context["readingTime"] : (function () { throw new RuntimeError('Variable "readingTime" does not exist.', 19, $this->source); })()), "html", null, true);
        echo " mins
            </small>
        </div>
    </div>
