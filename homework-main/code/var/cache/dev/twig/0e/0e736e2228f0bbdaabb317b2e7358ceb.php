...
class __TwigTemplate_44c15d065e29987180cd226e8a4449f0 extends Template
{
    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        echo "</h1>
                    <p class=\"text-muted\">Estimated reading time: ";
        // line 9
        echo twig_escape_filter($this->env, (isset($context["readingTime"]) || array_key_exists("readingTime", $context) ? $context["readingTime"] : (function () { throw new RuntimeError('Variable "readingTime" does not exist.', 9, $this->source); })()), "html", null, true);
        echo " min</p>
                </div>
